...
var require_react_development = __commonJS({
  "../../../../../../Users/daily/Desktop/d9/boka/node_modules/react/cjs/react.development.js"(exports, module2) {
    ...
    (function() {
      ...
      }, hasOwnProperty10 = Object.prototype.hasOwnProperty, REACT_CLIENT_REFERENCE$1 = Symbol.for("react.client.reference"), disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd;
      ...
      exports.cloneElement = function(element, config, children) {
        ...
        if (null != config) {
          ...
          a: {
            if (hasOwnProperty10.call(config, "ref") && (JSCompiler_inline_result = Object.getOwnPropertyDescriptor(
              config,
              "ref"
          ...
          for (propName in config)
            !hasOwnProperty10.call(config, propName) || "key" === propName || "__self" === propName || "__source" === propName || "ref" === propName && void 0 === config.ref || (props[propName] = config[propName]);
        }
      ...
      exports.createElement = function(type, config, children) {
        ...
        if (null != config)
          for (propName in didWarnAboutOldJSXRuntime || !("__self" in config) || "key" in config || (didWarnAboutOldJSXRuntime = true, console.warn(
            ...
            hasOwnProperty10.call(config, propName) && "key" !== propName && "__self" !== propName && "__source" !== propName && (i[propName] = config[propName]);
